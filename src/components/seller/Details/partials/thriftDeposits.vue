  ...
  data () {
    return {
      ...
      data: [
        ...
        { DebtorsName: 'User Vonny', Amount: '2,000,000', AmountPaid: '100,000', Duration: '2 Months', Daysleft: '20 Days', Loan_type: '40% interest Loan', Phone: '08033114572', Address: '8 Address Street', email: 'one@one.com', AgentsName:'James John' },
      ],
