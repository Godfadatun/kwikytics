<template>
  <div class="column flex-center bg-grey-3">
    ...
    <q-card flat class="bg-grey-3">
      <q-card-section class="row justify-center q-gutter-xl q-ma-none no-padding">
        <!-- Transactions -->
        <q-card flat class="q-pa-sm q-ma-xs " bordered style="width:360">
          ...
          <q-card-section class="row q-px-xs ">
            ...
            <q-btn no-caps stack flat size="26px" style="border: solid white 5px" class="q-pa-md bg-grey-3 col-xs-12 col-sm-12 col-md-6 " color="white" text-color="primary">
        ...
        <!-- Thrift -->
        <q-card flat class="q-pa-sm q-ma-xs" bordered style="max-width:260">
          ...
          <q-card-section class="row q-px-xs">
            ...
            <q-btn no-caps flat style="border: solid white 5px" class="q-pa-md bg-grey-3 col-xs-12 col-sm-12 col-md-6 text-h6" stack label="$1000" color="white" text-color="positive"><div class="text-primary text-caption">Incoming funds</div></q-btn>
          </q-card-section>
        </q-card>
        ...
        <q-card flat class="q-pa-sm q-ma-xs" bordered style="max-width:260">
          ...
          <q-card-section class="row q-px-xs">
            ...
            <q-btn no-caps flat style="border: solid white 5px" class="q-pa-md bg-grey-3 col-xs-12 col-sm-12 col-md-6 full-height" icon="money" color="white" text-color="primary">Loan History</q-btn>
          </q-card-section>
        </q-card>
